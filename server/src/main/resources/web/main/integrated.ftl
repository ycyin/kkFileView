...
<div class="container theme-showcase" role="main">
    ...
    <div class="page-header">
        <h1>接入说明</h1>
        本文档针对前端项目接入 文件预览功能 的说明，并假设 文件预览 的服务地址为：http://preview.gds.x。
    </div>
    <div class="well">
        ...
        <div style="font-size: 16px;">
            ...
            <p style="background-color: #2f332a;color: #cccccc;font-size: 14px;padding:10px;margin-top:10px;">
                var url = 'http://minio.gds.x/file/test.txt'; //要预览文件的访问地址 <br>
                window.open('http://preview.gds.x/onlinePreview?url='+encodeURIComponent(base64Encode(url)));
            </p>
        </div>
        <br>
        <div style="font-size: 16px;">
            ...
            <p style="background-color: #2f332a;color: #cccccc;font-size: 14px;padding:10px;margin-top:10px;">
                var originUrl = 'http://minio.gds.x/filedownload?fileId=1'; //要预览文件的访问地址<br>
                var previewUrl = originUrl + '&fullfilename=test.txt'<br>
                window.open('http://preview.gds.x/onlinePreview?url='+encodeURIComponent(Base64.encode(previewUrl)));
            </p>
        </div>
        <br>
        <div style="font-size: 16px;">
            ...
            <p style="background-color: #2f332a;color: #cccccc;font-size: 14px;padding:10px;margin-top:10px;">
                ...
                window.open('http://preview.gds.x/onlinePreview?url='+encodeURIComponent(Base64.encode(url)));
            </p>
        </div>
        <br>
        <div style="font-size: 16px;">
